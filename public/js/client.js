...
function handleUnauthorized() {
    ...
    Swal.fire({
        ...
        imageUrl: images.forbidden,
                    title: 'Ops, Yetkisiz',
            text: 'Ana bilgisayar kullanıcı kimlik doğrulamasını etkinleştirdi',
...
function roomIsBusy() {
    ...
    Swal.fire({
        ...
        position: 'center',
                    title: 'Oda meşgul',
        html: `Oda ${thisMaxRoomParticipants} kullanıcı ile sınırlıdır. <br/> Lütfen daha sonra tekrar deneyin`,
...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        position: 'center',
        input: 'text',
        inputPlaceholder: 'E-postanızı veya adınızı girin',
...
function userNameAlreadyInRoom() {
    ...
    Swal.fire({
        ...
        position: 'center',
                    title: 'Kullanıcı adı',
        html: `Kullanıcı adı zaten kullanımda. <br/> Lütfen başka bir tane deneyin`,
        showDenyButton: false,
        confirmButtonText: `OK`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
...
function checkShareScreen() {
    if (!isMobileDevice && isScreenEnabled && isScreenSharingSupported) {
        ...
        Swal.fire({
            ...
            position: 'center',
            icon: 'question',
            text: 'Ekranınızı paylaşmak istiyor musunuz?',
            showDenyButton: true,
...
function recordingOptions(options, audioMixerTracks) {
    Swal.fire({
        ...
        imageUrl: images.recording,
            ...
            text: 'Başlatmak istediğiniz kayıt türünü seçin. Ses tüm katılımcılardan kaydedilecektir.',
        showDenyButton: true,
        showCancelButton: true,
        cancelButtonColor: 'red',
        denyButtonColor: 'green',
...
function cleanMessages() {
    ...
    Swal.fire({
        ...
        position: 'top',
                    title: 'Sohbet',
            text: 'Sohbet mesajlarını temizle?',
...
function cleanCaptions() {
    ...
    Swal.fire({
        background: swBg,
        position: 'center',
                    title: 'Tüm altyazı deşifrelerini temizle?',
        imageUrl: images.delete,
        showDenyButton: true,
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
...
function ejectEveryone() {
    ...
    Swal.fire({
        ...
        text: 'Tüm katılımcıları odadan çıkarmak istediğinizden emin misiniz?',
        showDenyButton: true,
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
